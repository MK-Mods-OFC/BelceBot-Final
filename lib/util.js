...
module.exports = {
    ...
    consoleComando : (isGroup, categoria, comando, hex, timestampMsg, nomeUsuario, nomeChat)=>{
        ...
        if(isGroup){
          console.log('\x1b[1;31m~\x1b[1;37m>', module.exports.corTexto(`[GRUPO - ${categoria}]`, hex), tMensagem, module.exports.corTexto(comando), 'de', module.exports.corTexto(nomeUsuario), 'en', module.exports.corTexto(nomeChat), `(${module.exports.corTexto(`${tResposta}s`)})`)
        } else {
