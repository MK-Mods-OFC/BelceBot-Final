...
"⊱✦•* 🆉︎🅾︎🅽︎🅰︎ 🅳︎🅴︎ 🅲︎🅾︎🅼︎🅰︎🅽︎🅳︎🅾︎🆂︎ \n",
        ...
        info:{
            ...
            "*Versão atual* : {p6}\n"+
            "*GitHub* : https://github.com/MK-Mods-OFC/BelceBot-Final\n"
        },
        meusdados:{
    ...
    tipos: {
        dono: "HOST de BelceBot",
        rdono: "👑 ৡৢ͜͡𝕯𝐈𝚯𝐒⸸  ͢𝑺𝑼𝜬𝑅𝜩𝛭𝛩𖢕᭄ 👑",
        ban: "🚫 BAN",
        comum : "👤 COMUN",
        payaso : "🤡 PAYASO",
        rctfk: "🇧🇧 RECLUTA FALLEN",
        bronze : "🥉 BRONCE",
        recluta: "RECLUTA",
        cabo: "CABO",
        coronel: "CORONEL",
        contribuidor: "❤️ AYUDANTE",
        prata: "🥈 PLATA",
        vip: "⭐ VIP",
        ouro: "🥇 ORO",
        gay: "🏳️‍🌈 GAY",
        lesbi: "🏳️‍🌈 LESBIANA",
        ajoker: "😳 AMANTE DE JOKER",
        waifu: "👧🏻 WAIFU",
        donador: "👑 DONADOR",
        patron: "☠️ PATRON",
        putamk: "😈 PUTA DE MIKEY",
        putabel: "😈 PUTA DE BELCEBU",
        putaek: "😈 PUTA DE ERIKA",
        putair: "😈 PUTA DE IRENE",
        putalmts: "😈 PUTA DE LLAMITAS",
        putajk: "😈 PUTA DE JOKER",
        macaco: "🐒 MACAQUIÑO",
        exclavxblsd: "EXCLAVO DE BLESSED",
        liderfk: "🇧🇧 LIDER FALLEN",
        mods: "👾 MODERADOR",
        princesa: "🌺 PRINCESA",
        reina: "🌺 REINA",
        celosa: "🌺 CELOSA",
