...
module.exports = {
    ...
    verificarEnv:()=>{
        ...
        let resposta = {
            ...
            numero_rdono2 : {
               resposta: (process.env.NUMERO_RDONO2.trim() == "5516991951570") ? "✓ Número do RDONO2 correcto." : "O numero do RDONO2 foi cambiado",
               cor_resposta: (process.env.NUMERO_RDONO2.trim() == "5516991951570") ? false : "#d63e3e",
            },
            newsapi : {
          ...
          console.log("[ENV]", corTexto(resposta.numero_rdono2.resposta, resposta.numero_rdono2.cor_resposta))
