...
|>---- ☾ 🤖 *MENU SPAM* 🤖☽
|
|- Escribe uno de los comandos de abajo:
|
|- *×spam* 0 -> Instagram
|- *×spam* 1 -> TikTok
|- *×spam* 2 -> Discord
|- *×spam* 3 -> Twitch
|- *×spam* 4 -> YouTube
|- *×spam* 5 -> Grupos de WhatsApp
|- *×spam* 6 -> Bots de WhatsApp
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
|
|- @mikey69yt
|  instagram.com/mikey69yt
|- @gemagh_12
|  instagram.com/gemagh_12
|- @kng_blxssxd
|  instagram.com/kng_blxssxd
|
|
|- Si quieres estar tambien en 
|  el apartado de spam, contacta 
|  con alguno de mis creadores
...
|>---- ☾ 🤖 *TWITCH* 🤖☽
|
|- twitch.tv/MK-Mods-OFC
|- twitch.tv/gemagh1322
|
|
|- Si quieres estar tambien en 
|  el apartado de spam, contacta 
...
|- *×gay* @user - Mostra a porcentagem de homossexuais de uma pessoa no grupo.
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
        } else {
            return `__| ☾ *🤖 ${process.env.NOME_BOT.trim()}®* ☽ 
...
Criador do Bot : Mikey
Github : https://github.com/MK-Mods-OFC
