        ...
        if(comandoExiste){
            if(lista_comandos.utilidades.includes(command)){
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    consoleComando(isGroupMsg, "STICKERS", command, "#ae45d1", t, username, formattedTitle)
                })
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    consoleComando(isGroupMsg, "DESCARGAS", command, "#2195cf", t, username, formattedTitle)
                })
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    if(isGroupMsg) consoleComando(isGroupMsg, "ADMIN", command, "#e0e031", t, username, formattedTitle)
                }, {priority: 1})
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    consoleComando(isGroupMsg, "DIVERSION", command, "#22e3dd", t, username, formattedTitle)
                })
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    consoleComando(isGroupMsg, "CREADOR", command, "#d1d1d1", t, username, formattedTitle)
                }, {priority: 2})
            ...
            if(isGroupMsg && (type == MessageTypes.IMAGE || type == MessageTypes.VIDEO) && grupoInfo.autosticker){
                ...
                await queueMensagem.add(async ()=>{
                    ...
                    consoleComando(isGroupMsg, "STICKERS", "AUTO-STICKER", "#ae45d1", t, username, formattedTitle)
                })
            }
